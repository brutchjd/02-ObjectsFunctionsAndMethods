...
def try_methods():
    ...
    """
    #define turtles
    lilTurt = rg.SimpleTurtle()
    lilTurt.pen = rg.Pen('brown', 5)
    #movement
    lilTurt.forward(150)
    lilTurt.left(90)
    lilTurt.forward(50)
    lilTurt.backward(100)
...
def try_methods_and_functions():
    ...
    """
    #definition
    tortilla = rg.SimpleTurtle()
    tortilla.pen = rg.Pen('blue', 5)
    #1
    tortilla.backward(150)
    #2
    tortilla.speed = 1
    draw_many_squares(tortilla, 2, 100, 30)
    #3
    tortilla.speed = 5
    tortilla.pen = rg.Pen('red', 5)
    draw_many_squares(tortilla, 10, 50, 15)
    #4
    tortilla.speed = 100
    tortilla.pen = rg.Pen('red', 35)
    draw_many_squares(tortilla, 8, 300, 60)
    #5
    tortilla.pen = rg.Pen('black', 3)
    tortilla.backward(200)
    tortilla.draw_circle(30)
    tortilla.draw_square(50)
