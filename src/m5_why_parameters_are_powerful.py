...
def main():
    ...
    #better_draw_circles(rg.Point(-50,50), 4)
    #better_draw_circles(rg.Point(100,-150), 10)
    #even_better_draw_circles(rg.Point(100,50),10,10,'red',9)
    #even_better_draw_circles(rg.Point(-200,0),20,8,'green',5)

    #Picture
    even_better_draw_circles(rg.Point(0,0), 5, 10, 'red', 3)
    even_better_draw_circles(rg.Point(0,0), 9, 10, 'green', 3)
    even_better_draw_circles(rg.Point(0, 0), 13, 10, 'blue', 3)
    even_better_draw_circles(rg.Point(0,0), 17, 10, 'purple', 3)
    even_better_draw_circles(rg.Point(0, 0), 21, 10, 'magenta', 3)
    even_better_draw_circles(rg.Point(0, 0), 25, 10, 'yellow', 3)
...
def better_draw_circles(point, delrad):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN delrad pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(delrad)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(delrad * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point, delrad, quantity, color, thickness):
    ...
    for k in range(1, quantity + 1):  # k becomes 1, 2, 3, ... 10
